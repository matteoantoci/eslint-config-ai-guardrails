...
const castPlugins = (plugins: Record<string, unknown>): Linter.Config['plugins'] =>
  plugins as unknown as Linter.Config['plugins'];
...
export const createTypeScriptPreset = (options: TypeScriptOptions = {}): Linter.Config[] => {
